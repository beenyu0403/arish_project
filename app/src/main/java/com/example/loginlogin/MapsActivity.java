...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private ArrayList<GetterJson> getterJsonArrayList = new ArrayList<GetterJson>();
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        for(int i=0; i<getterJsonArrayList.toArray().length; i++){
            MarkerOptions markerOptions = new MarkerOptions();
            float latitude = Float.parseFloat(getterJsonArrayList.get(i).getLatitude());
            float longitude = Float.parseFloat(getterJsonArrayList.get(i).getLongitude());
            String title = getterJsonArrayList.get(i).getTitle();

            markerOptions.position(new LatLng(latitude,longitude)).title(title);

            BitmapDrawable bitmap = (BitmapDrawable) getResources().getDrawable(R.drawable.marker_icon);
            Bitmap b = bitmap.getBitmap();
            Bitmap smallMarker = Bitmap.createScaledBitmap(b, 85, 115, false);
        ...
        */
        ...
        if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED &&
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "현재 위치를 사용하려면 위치 접근 권한이 필요합니다.",
    ...
    private void startLocationUpdates() {
        ...
        if (!checkLocationServicesStatus()) {
            ...
            if (hasFineLocationPermission != PackageManager.PERMISSION_GRANTED ||
                ...
                Log.d(TAG, "startLocationUpdates : 위치 접근 권한을 안 가지고 있음");
                return;
            }
    ...
    public void setDefaultLocation() {
        ...
        String markerSnippet = "위치 접근 권한과 GPS 활성 요부 확인하세요";
        ...
        if (permsRequestCode == PERMISSIONS_REQUEST_CODE && grandResults.length == REQUIRED_PERMISSIONS.length) {
            ...
            if (check_result) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])
                    ...
                    Snackbar.make(mLayout, "위치 접근 권한이 거부되었습니다. 설정(앱 정보)에서 위치 접근 권한을 허용해야 합니다. ",
                            Snackbar.LENGTH_INDEFINITE).setAction("확인", new View.OnClickListener() {
            ...
            case GPS_ENABLE_REQUEST_CODE:
                ...
                if (checkLocationServicesStatus()) {
                    if (checkLocationServicesStatus()) {
                        ...
                        Log.d(TAG, "onActivityResult : GPS 활성화 돼 있음");
    ...
    public void mOnClick(View v){
        ...
        if(v.getId() == R.id.home){
            ...
            Intent intent1 = new Intent(MapsActivity.this, search1.class);
            intent1.putExtra("userID",userID);
            startActivity(intent1);
        } else if(v.getId() == R.id.ticket || v.getId() == R.id.ticket2){
            Intent in = new Intent(MapsActivity.this, reservation_ticket.class);
            in.putExtra("userID",userID);
            startActivity(in);
        }else if (v.getId() == R.id.position){
            Intent ie = new Intent(MapsActivity.this, MapsActivity.class);
            ie.putExtra("userID",userID);
            startActivity(ie);
        } else if(v.getId() == R.id.profile_icon){
            Intent intent = new Intent(MapsActivity.this, profile1.class);
